...
const DB_URL =
  "mongodb+srv://syed_abdulrab:syedabdulrab@cluster0.nt7qb.mongodb.net/cloud_auth_svc?retryWrites=true&w=majority";
// Connect to MongoDB
...
app.post("/updateQuotas/:userId", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Internal server error rola parh gaya hai bhai" });
  }
});
